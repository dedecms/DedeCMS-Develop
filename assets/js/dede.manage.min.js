...
// 更新
function DedeCMS_JSCODE_Version_Checked_Update(aid = 0) {
...
// 审核
function DedeCMS_JSCODE_Version_Checked_Review(aid = 0) {
  _DedeCMS_JSCODE_Version_Checked_CallControlURL(
...
// 推荐
function DedeCMS_JSCODE_Version_Checked_Recommend(aid = 0) {
  _DedeCMS_JSCODE_Version_Checked_CallControlURL(
...
// 删除
function DedeCMS_JSCODE_Version_Checked_Delete(aid = 0) {
  _DedeCMS_JSCODE_Version_Checked_CallControlURL(
...
// 移动
function DedeCMS_JSCODE_Version_Checked_Move(cid) {
  _DedeCMS_JSCODE_Version_Checked_CallControlModal(
    "archives_do.php?dopost=moveArchives&channelid=" +
      cid +
      "&rnd=" +
      Math.random()
  );
...
function _DedeCMS_JSCODE_Version_Checked_CallControlModal(url) {
  var qstr = _DedeCMS_JSCODE_Version_GetCheckedItem();
  if (qstr == "") {
    alert("必须选择一个或多个文档！");
    return;
  } else {
