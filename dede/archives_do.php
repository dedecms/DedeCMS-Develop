...
---------------------------*/
    ...
    if ($fmdo == 'yes') {
        ...
        $wintitle = "文档管理-删除文档";
        $wecome_info = "<ul class='uk-breadcrumb'><li><a href='" . $ENV_GOBACK_URL . "'>文档管理</a></li><li><span>删除文档</span></li></ul>";
        $win = new OxWindow();
...
------------------------------*/
    ...
    if ($fmdo == 'yes') {
        ...
        $wecome_info = "<ul class='uk-breadcrumb'><li><a href='recycling.php'>文档回收站</a></li><li><span>清空所有文档</span></li></ul>";
        $win = new OxWindow();
        $win->Init("archives_do.php", "js/blank.js", "POST");
        $win->AddHidden("fmdo", "yes");
        $win->AddHidden("dopost", $dopost);
...
------------------------------*/
    ...
    if ($fmdo == 'yes') {
        ...
        $wintitle = "文档管理-删除文档";
        $wecome_info = "<ul class='uk-breadcrumb'><li><a href='recycling.php'>文档管理</a></li><li><span>删除文档</span></li></ul>";
        $win = new OxWindow();
        $win->Init("archives_do.php", "js/blank.js", "POST");
        $win->AddHidden("fmdo", "yes");
        $win->AddHidden("dopost", $dopost);
